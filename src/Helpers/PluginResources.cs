namespace Loupedeck.VoxRingPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.VoxRingPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.VoxRingPlugin.Resources.Resource.txt`.
